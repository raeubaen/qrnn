...
#    
    ...
    inputtrain = 'tmp_dfs/weightedsys/df_{}_{}_train_split{}.h5'.format(data_key, EBEE, ispl)
    inputtest = 'tmp_dfs/weightedsys/df_{}_{}_test.h5'.format(data_key, EBEE)
    ...
    fit_standard_scaler(df_train, vars_tran, transformer_file)
