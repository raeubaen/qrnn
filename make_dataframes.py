...
def main(options):
    ...
    cut = 'tagPt>40 and tagR9>0.8 and mass>65 and mass<100 and probeChIso03<6 and tagScEta>-2.1 and tagScEta<2.1 and probePassEleVeto==0'

    cutIso = {'EB': 'tagPt>40 and tagR9>0.8 and mass>65 and mass<100 and probeSigmaIeIe<0.0105 and tagScEta>-2.1 and tagScEta<2.1 and probePassEleVeto==0',
              'EE': 'tagPt>40 and tagR9>0.8 and mass>65 and mass<100 and probeSigmaIeIe<0.028 and tagScEta>-2.1 and tagScEta<2.1 and probePassEleVeto==0'}

    cutplots = 'tagPt>40 and probePt>20 and mass>65 and mass<100 and probePassEleVeto==0 and tagScEta<2.5 and tagScEta>-2.5' 
